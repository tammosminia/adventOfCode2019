...
main = hspec $ do
  ...
  describe "day11" $ do
    it "stepRobot first steps" $ do
      let (p1,[o1]) = stepToOutput $ createRP day11ProgramC [0,0]
      let (p2,[o2]) = stepToOutput p1
      let (p3,[o3]) = stepToOutput p2
      let (p4,[o4]) = stepToOutput p3
      [o1,o2,o3,o4] `shouldBe` [1,0,1,1]
